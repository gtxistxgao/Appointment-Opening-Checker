...
function checkAvailabilityDates(data, expectedDate) {
...
function Check() {
	...
	var url = "https://ais.usvisa-info.com/en-ca/niv/schedule/30995436/appointment/days/95.json?appointments[expedite]=false";
	...
	xmlhttp.onreadystatechange = function () {
		if (this.readyState == 4) {
			...
			var expectedDate = '2020-03-15';
			checkAvailabilityDates(data, expectedDate);
		}
	};
