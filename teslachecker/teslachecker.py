...
def get_and_send_sms():
    ...
    headers = {
        ...
        "if-none-match": 'W/"33184-CfZKAuOLFC9T7NiJiyYJ9VTft5U"',
    ...
    if response.status_code == 200:
        ...
        if len(output_data) > 0:
            ...
            send_twilio_sms("No available model Y: https://www.tesla.com/inventory/new/my?arrangeby=relevance&zip=98021&range=200")
    else:
